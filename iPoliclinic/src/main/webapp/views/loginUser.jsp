...
<html lang="en">
  ...
  <body>
     <div class="container">
      <form class="form-signin" method="post" action="/iClinic-1.0-SNAPSHOT/loginUser">
      ...
      <form class="form-signin" method="post" action="/iClinic-1.0-SNAPSHOT/registration">
...
<h2 class="form-signin-heading">Login with OAuth 2.0</h2><table class="table table-striped">
 <tr><td><a href="/iClinic-1.0-SNAPSHOT/oauth2/authorization/a0f878029df7c317da99b8fc758db82442ff05ce">GitHub</a></td></tr>
</table>
</div>
</body></html>